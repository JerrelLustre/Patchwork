...
@section('content')
    ...
    <section class="mt-[4rem] h-full w-[276px] flex flex-col justify-center items-center mx-auto ">
        ...
        <form method="POST" action="/public/user/authenticate" class="flex-col flex items-center flex-grow">
            @csrf
            <div>
            @error('email')
            ...
            <div class="mt-8">
                <a href="./signup" class="block font-pop text-sm text-center font-medium text-black dark:text-white underline ">Sign up for an account</a>
