...
@section('content')
    ...
    <div class="mt-[4rem]  w-[17.25rem] flex flex-col justify-center items-center mx-auto ">
        ...
        <form method="POST" action="/public/user" class="flex-col flex items-center flex-grow">
            @csrf
            <div>
            ...
            <div class="mt-8 flex flex-col justify-center">
                <a href="./login" class="block font-pop text-sm text-center font-medium text-black dark:text-white underline ">Already have an account? <span class="text-menucolorbutton2">Login<span></a>
