...
<!-- Sub-heading -->
<div class="flex justify-between max-w-[20.9375rem] mx-auto mb-6">
...
">
    <!-- Course Item -->
    <div class="relative rounded-3xl col-span-1 px-1.5 pt-1.5 pb-2 h-[11.875rem] bg-onlineStoreBgColor my-5 shadow-btn">
        <!-- Label -->
        <div class="text-base text-white font-normal w-fit absolute z-10 left-0 -top-2">
            <h2 class="rounded-4xl px-4 bg-onlineStoreTagColor font-pop">Enterprise</h2>
        </div>
        <!-- End: label -->
        <!-- Image background -->
